#!/bin/bash
# Set up a cosmovisor service to join the witval chain.
...
# CHAIN_BINARY_URL='https://github.com/vitwit/ics-testnets/raw/main/game-of-chains-2022/witval/witvalchain'
